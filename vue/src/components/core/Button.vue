...
const props = defineProps<{ text: string, color: ButtonColor }>();
...
const buttonClass = computed(() => {
  return `border border-black focus:ring-1 px-4 py-2 w-full text-sm font-bold text-white rounded ${buttonColors[props.color]}`;
});
</script>
